...
class BPSDataModule(pl.LightningDataModule):
    ...
    def prepare_data(self) -> None:
        ...
        # train_csv file.
        save_tiffs_local_from_s3(self.s3_client, self.bucket_name, self.s3_path, self.train_dir/self.train_csv, "../../data/processed/")

        # call the save_tiffs_local_from_s3 function to download tiffs from the
        # val_csv file.        
        save_tiffs_local_from_s3(self.s3_client, self.bucket_name, self.s3_path, self.val_dir/self.val_csv, "../../data/processed/")
        ...
        if self.test_csv is not None:
            ...
            save_tiffs_local_from_s3(self.s3_client, self.bucket_name, self.s3_path, self.test_dir/self.test_csv, "../../data/processed/")
    ...
    def setup(self, stage: str):
        ...
        if stage == "train":
            ...
            self.train_dataset = BPSMouseDataset(meta_csv_file=self.train_csv, 
        ...
        if stage == "validate":
            ...
            self.val_dataset = BPSMouseDataset(meta_csv_file=self.val_csv,
        ...
        if stage == "test":
            ...
            self.test_dataset = BPSMouseDataset(meta_csv_file=self.test_csv,
    ...
    def train_dataloader(self) -> TRAIN_DATALOADERS:
        ...
        """
        return DataLoader(self.train_dataset, self.batch_size, self.num_workers)
    
    def val_dataloader(self) -> EVAL_DATALOADERS:
        """
        Returns the validation dataloader.
        """
        return DataLoader(self.val_dataset, self.batch_size, self.num_workers)
